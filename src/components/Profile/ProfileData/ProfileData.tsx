...
const ProfileData = ({
  ...
  // let hasNaN: any = Object.values(profile.contacts).includes(null) ? Object.values(profile.contacts).filter((p: any) => p !== null) : null
  // console.log(isOwner)
let hasNaN: any = null;
if (profile.contacts && typeof profile.contacts === 'object') {
  hasNaN = Object.values(profile.contacts).includes(null)
    ? Object.values(profile.contacts).filter((p: any) => p !== null)
    : null;
}
  ...
  return (
    <div className={style.Data}>
      <ul className={style.DataList}>
        ...
        <div>
         {profile.contacts && typeof profile.contacts === 'object' && Object.keys(profile.contacts).map(key => {
  return (
    <Contacts
      key={key}
      contactTitle={key}
